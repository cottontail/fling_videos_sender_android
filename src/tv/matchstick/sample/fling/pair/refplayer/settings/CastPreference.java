...
public class CastPreference extends PreferenceActivity
    ...
    public static final String MODE_SELCTION_KEY = "mode_target";
    ...
    private ListPreference mModeListPreference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mModeListPreference = (ListPreference) getPreferenceScreen()
                .findPreference(MODE_SELCTION_KEY);
        String modeValue = getMode(this);
        String modeSummary = getResources().getString(R.string.prefs_mode_title_summary, modeValue);
        mModeListPreference.setSummary(modeSummary);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
        ...
        if (VOLUME_SELCTION_KEY.equals(key)) {
            ...
            android.os.Process.killProcess(android.os.Process.myPid());
        } else if (MODE_SELCTION_KEY.equals(key)) {
            String value = sharedPreferences.getString(MODE_SELCTION_KEY, "");
            String summary = getResources().getString(R.string.prefs_mode_title_summary, value);
            setMode(this, value);
            mModeListPreference.setSummary(summary);
            android.os.Process.killProcess(android.os.Process.myPid());
        }
    }
    ...
    public static void setMode(Context context, String mode) {
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(context);
        sharedPref.edit().putString(MODE_SELCTION_KEY, mode).commit();
    }
    
    public static String getMode(Context context) {
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(context);
        String mode = sharedPref.getString(MODE_SELCTION_KEY, "TLS");
        return mode;
    }
