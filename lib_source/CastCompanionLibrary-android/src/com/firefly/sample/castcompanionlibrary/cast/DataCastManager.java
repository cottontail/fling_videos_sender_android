...
import com.firefly.sample.castcompanionlibrary.cast.callbacks.DataCastConsumerImpl;
import com.firefly.sample.castcompanionlibrary.cast.callbacks.IDataCastConsumer;
...
//            }
        ...
        try {
            ...
            synchronized (mDataConsumers) {
                for (IDataCastConsumer consumer : mDataConsumers) {
                    try {
                        consumer.onApplicationConnected(appMetadata, applicationStatus,
                                wasLaunched);
                    } catch (Exception e) {
    ...
    public void onMessageReceived(FlingDevice flingDevice, String namespace, String message) {
        synchronized (mDataConsumers) {
            for (IDataCastConsumer consumer : mDataConsumers) {
                try {
                    consumer.onMessageReceived(flingDevice, namespace, message);
                } catch (Exception e) {
