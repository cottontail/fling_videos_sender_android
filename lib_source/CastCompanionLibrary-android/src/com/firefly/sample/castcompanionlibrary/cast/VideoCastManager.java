...
import com.firefly.sample.castcompanionlibrary.cast.dialog.video.VideoMediaRouteDialogFactory;
...
import com.firefly.sample.castcompanionlibrary.cast.player.IMediaAuthService;
import com.firefly.sample.castcompanionlibrary.cast.player.VideoCastControllerActivity;
import com.firefly.sample.castcompanionlibrary.notification.VideoCastNotificationService;
import com.firefly.sample.castcompanionlibrary.remotecontrol.RemoteControlClientCompat;
import com.firefly.sample.castcompanionlibrary.remotecontrol.RemoteControlHelper;
import com.firefly.sample.castcompanionlibrary.remotecontrol.VideoIntentReceiver;
import com.firefly.sample.castcompanionlibrary.utils.LogUtils;
import com.firefly.sample.castcompanionlibrary.utils.Utils;
import com.firefly.sample.castcompanionlibrary.widgets.IMiniController;
import com.firefly.sample.castcompanionlibrary.widgets.MiniController;
import com.firefly.sample.castcompanionlibrary.widgets.MiniController.OnMiniControllerChangedListener;
...
public class VideoCastManager extends BaseCastManager
    ...
    private VolumeType mVolumeType = VolumeType.STREAM;
...
//            }
    ...
    /*
     * (non-Javadoc)
     * @see com.firefly.sample.castcompanionlibrary.widgets.MiniController.
    ...
    /*
     * (non-Javadoc)
     * @see com.firefly.sample.castcompanionlibrary.cast.BaseCastManager# onConnectivityRecovered()
     */
    @Override
...
//            }
    ...
    private void setUpRemoteControl(final MediaInfo info) {
        if (mContext == null || !isFeatureEnabled(BaseCastManager.FEATURE_LOCKSCREEN)) {
            return;
        }
