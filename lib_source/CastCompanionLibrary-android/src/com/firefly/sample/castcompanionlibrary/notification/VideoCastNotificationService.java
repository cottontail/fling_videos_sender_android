...
package com.firefly.sample.castcompanionlibrary.notification;
...
public class VideoCastNotificationService extends Service {
    ...
    public static final String ACTION_TOGGLE_PLAYBACK =
            "com.firefly.sample.castcompanionlibrary.action.toggleplayback";
    public static final String ACTION_STOP =
            "com.firefly.sample.castcompanionlibrary.action.stop";
    public static final String ACTION_VISIBILITY =
            "com.firefly.sample.castcompanionlibrary.action.notificationvisibility";
